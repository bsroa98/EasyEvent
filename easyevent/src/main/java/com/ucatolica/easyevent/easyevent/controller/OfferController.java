...
@Tag(name="offer", description = "Esta API gestiona las operaciones sobre la entidad OfferUser")
@RestController
public class OfferController {
    ...
    @Parameters({
            ...
            @Parameter(name="experiencia", description="Experiencia obtenida", example="Mesero")
    })
